...
public JavaLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("break", this), new Integer(117));
	literals.put(new ANTLRHashString("while", this), new Integer(115));
	literals.put(new ANTLRHashString("new", this), new Integer(160));
	literals.put(new ANTLRHashString("instanceof", this), new Integer(147));
	literals.put(new ANTLRHashString("implements", this), new Integer(108));
	literals.put(new ANTLRHashString("synchronized", this), new Integer(95));
	literals.put(new ANTLRHashString("float", this), new Integer(85));
	literals.put(new ANTLRHashString("package", this), new Integer(63));
	literals.put(new ANTLRHashString("return", this), new Integer(119));
	literals.put(new ANTLRHashString("throw", this), new Integer(121));
	literals.put(new ANTLRHashString("null", this), new Integer(159));
	literals.put(new ANTLRHashString("threadsafe", this), new Integer(94));
	literals.put(new ANTLRHashString("protected", this), new Integer(91));
	literals.put(new ANTLRHashString("/**/", this), new Integer(62));
	literals.put(new ANTLRHashString("class", this), new Integer(103));
	literals.put(new ANTLRHashString("throws", this), new Integer(110));
	literals.put(new ANTLRHashString("do", this), new Integer(116));
	literals.put(new ANTLRHashString("strictfp", this), new Integer(41));
	literals.put(new ANTLRHashString("super", this), new Integer(73));
	literals.put(new ANTLRHashString("transient", this), new Integer(92));
	literals.put(new ANTLRHashString("native", this), new Integer(93));
	literals.put(new ANTLRHashString("interface", this), new Integer(104));
	literals.put(new ANTLRHashString("final", this), new Integer(39));
	literals.put(new ANTLRHashString("if", this), new Integer(113));
	literals.put(new ANTLRHashString("double", this), new Integer(87));
	literals.put(new ANTLRHashString("volatile", this), new Integer(96));
	literals.put(new ANTLRHashString("assert", this), new Integer(122));
	literals.put(new ANTLRHashString("catch", this), new Integer(127));
	literals.put(new ANTLRHashString("try", this), new Integer(125));
	literals.put(new ANTLRHashString("enum", this), new Integer(105));
	literals.put(new ANTLRHashString("int", this), new Integer(84));
	literals.put(new ANTLRHashString("for", this), new Integer(123));
	...
	literals.put(new ANTLRHashString("private", this), new Integer(89));
	literals.put(new ANTLRHashString("default", this), new Integer(107));
	literals.put(new ANTLRHashString("false", this), new Integer(158));
	literals.put(new ANTLRHashString("this", this), new Integer(109));
	literals.put(new ANTLRHashString("static", this), new Integer(66));
	literals.put(new ANTLRHashString("abstract", this), new Integer(40));
	literals.put(new ANTLRHashString("continue", this), new Integer(118));
	literals.put(new ANTLRHashString("finally", this), new Integer(126));
	literals.put(new ANTLRHashString("else", this), new Integer(114));
	literals.put(new ANTLRHashString("import", this), new Integer(65));
	literals.put(new ANTLRHashString("void", this), new Integer(79));
	literals.put(new ANTLRHashString("switch", this), new Integer(120));
	literals.put(new ANTLRHashString("true", this), new Integer(157));
...
tryAgain:
	...
	public final void mEMPTY_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = EMPTY_COMMENT;
		int _saveIndex;
