...
/**
 * Contains unit tests showing how a transformer could work that performs several tasks such as
 * modifying, deleting or adding elements at the same time.<br>
 * 
 * Shows a transformer, modifying a document, adding elements and deleting other at the same time.
 */
public class ComplexTransformerTest {

    /**
     * Shows a transformer, modifying a document, adding elements and deleting other at the same
     * time.
     * 
